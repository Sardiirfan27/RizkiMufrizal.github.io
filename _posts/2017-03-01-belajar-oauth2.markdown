...
Pada grant type ini, biasanya authorization server tidak akan memberikan refresh token dikarenakan penyimpanan refresh token yang tidak aman. Berikut adalah gambar grant type implicit client yang saya ambil dari [dokumentasi digital ocean](http://adf.ly/1lPOos){:target="_blank"}.
...
Bagi anda yang ingin melihat contoh source code codingan, silahkan lihat di [Spring OAuth2 Custom](http://adf.ly/1lPOlp){:target="_blank"}. Sekian artikel mengenai Belajar OAuth2, jika ada saran dan komentar silahkan isi dibawah dan terima kasih :)
