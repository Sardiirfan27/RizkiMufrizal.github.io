...
Pada artikel kali ini, penulis akan menggunakan vagrant. Bagi yang belum tau apa itu vagrant, silahkan lihat di [Belajar Vagrant](https://rizkimufrizal.github.io/belajar-vagrant/). Pada kesempatan kali ini, penulis menggunakan box [ubuntu/trusty64](https://atlas.hashicorp.com/ubuntu/boxes/trusty64) atau ubuntu 14.04 LTS.
