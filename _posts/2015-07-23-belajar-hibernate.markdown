...
Setelah melakukan banyak [konfigurasi untuk coding java](https://rizkimufrizal.github.io/instalasi-perlengkapan-coding-java/){:target="_blank"}, selanjutnya kita akan belajar tentang framework hibernate. Sebelum kita belajar hibernate, alangkah baiknya kita mengenal terlebih dahulu konsep dari hibernate itu sendiri.
...
Jangan lupa sesuaikan dengan package project anda. Sekian tutorial belajar hibernate dan Terima kasih :). Untuk source code lengkap, penulis publish di [Belajar Hibernate](https://github.com/RizkiMufrizal/Belajar-Hibernate){:target="_blank"}.
